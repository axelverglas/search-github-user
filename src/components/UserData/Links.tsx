...
const Data = ({ children }: DataProps) => {
    return (
        <span className="text-[1.4rem] dark:text-white text-gray-special-2 break-all ml-8 md:text-2xl">
            {children}
        </span>
    )
}
...
const Li = ({ children, links }: LiProps) => {
    return (
        <li className={`flex items-center mt-4 ${!links && "opacity-50"}`}>
            {children}
        </li>
    )
}
...
export default function Links({ links }: LinksProps) {
    ...
    return (
        <ul className="list-none grid grid-cols-1 mt-10 md:grid-cols-2">
            <Li links={links.location}>
                <svg className="w-[20px]" height="20" width="14" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <Data>
                    {links.location || "Indisponible"}
                </Data>
            </Li>
            <Li links={links.blog}>
                {links.blog ? (
                    <a href={links.blog} target="_blank" rel="noopener noreferrer" className="grid grid-cols-links">
                        <svg className="w-[20px]" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
            ...
            <Li links={links.twitter}>
                {links.twitter ? (
                    <a href={links.twitter} target="_blank" rel="noopener noreferrer" className="grid grid-cols-links">
                        <svg className="w-[20px]" height="18" width="20" xmlns="http://www.w3.org/2000/svg">
                            <path
